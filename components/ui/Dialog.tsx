...
export function Dialog({
  ...
  return <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-in zoom-in-95 duration-200">
        ...
        {/* Content */}
        <div className="p-6">
          {children ? children : <p className="text-gray-700 leading-relaxed">{description}</p>}
        </div>

        {/* Footer */}
        {showFooter && <div className="p-6 border-t border-gray-200 bg-gray-50 rounded-b-2xl flex justify-end gap-3 sticky bottom-0">
